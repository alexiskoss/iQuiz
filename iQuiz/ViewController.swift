...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //define subjects
        let math = Subject(subjectName: "Mathematics", subjectDesc: "Ready to test your math skills?!")
        let marvel = Subject(subjectName: "Marvel Super Heroes", subjectDesc: "How well do you really know your super heroes?")
        let science = Subject(subjectName: "Science", subjectDesc: "Do you got what it takes to be a scientist?")
